...
public class Base64FilterInputStream extends AbstractEncodingFilterInputStream {
	 ...
	 *            Input stream to wrap.
	 * @param charsPerLine
	 *            Number of characters per line of encoded input. Must be one of
	 *            {@link #LINE_LENGTH_64}, {@link #LINE_LENGTH_76}, or 0 to
	 *            indicate no wrapping.
	 */
	public Base64FilterInputStream(final InputStream in, final int charsPerLine) {
		super(in);
		if (charsPerLine != 0 && charsPerLine != LINE_LENGTH_64
