 ...
 * 
 */
public abstract class AbstractEncodingFilterOutputStream extends
		FilterOutputStream {
	 ...
	 *
	 * @param data
	 *            Raw bytes to be encoded and written.
	 * @param offset
	 *            Starting index of data to be written in input byte array.
	 * @param length
	 *            Number of bytes to be written from input byte array.
	 *
	 * @throws IOException
	 *             On write errors.
	 */
	protected abstract void writeEncoded(final byte[] data, final int offset,
