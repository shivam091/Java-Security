...
/**
 * <p>
 * <code>AbstractCryptTask</code> provides common methods for crypt ant tasks.
 * </p>
 *
 * @author shivam
 * 
...
public abstract class AbstractCryptTask extends Task {
	 ...
	 * @throws IOException
	 *             On IO errors reading symmetric key.
	 */
	protected SymmetricAlgorithm createAlgorithm() throws CryptException,
			IOException {
		final SymmetricAlgorithm crypt = SymmetricAlgorithm.newInstance(
				this.algorithm, this.mode, this.padding);
		if (this.iv != null) {
