...
public interface EncryptionAlgorithm extends Algorithm {
	 ...
	 *
	 * @param k
	 *            Public, private, or secret key used for encryption or
	 *            decryption.
	 */
	 ...
	 *            Input plaintext bytes.
	 * @param converter
	 *            Converter that converts ciphertext output bytes to a string
	 *            representation.
	 *
	 ...
	 *            Input ciphertext bytes.
	 * @param converter
	 *            Converter that converts the ciphertext input string into raw
	 *            bytes required by the cipher algorithm.
	 *
	 * @return Plaintext resulting from ciphertext decryption.
	 *
	 * @throws CryptException
