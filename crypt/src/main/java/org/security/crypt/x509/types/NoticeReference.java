...
public class NoticeReference {
	 ...
	 *            Organization name.
	 * @param numbers
	 *            Notice numbers that typically identify locations in a
	 ...
	 *         belonging to the organization. A common use case is for
	 *         application software to display the blocks of text from a
	 *         referenced document at locations specified by this field.
	 */
	...
	public String toString() {
		return String.format("(%s, %s)", organization,
				Arrays.toString(noticeNumbers));
	}
