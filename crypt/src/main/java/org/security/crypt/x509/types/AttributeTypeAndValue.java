...
public class AttributeTypeAndValue {
	 ...
	 *            Attribute value.
	 */
	public AttributeTypeAndValue(final String typeOid,
	...
	/**
	 * Creates a new instance with the given well-known attribute type and
	 * value.
	 *
	 * @param attributeType
	 *            Attribute type.
	 ...
	 *            Attribute value.
	 */
	public AttributeTypeAndValue(final AttributeType attributeType,
			final String attributeValue) {
