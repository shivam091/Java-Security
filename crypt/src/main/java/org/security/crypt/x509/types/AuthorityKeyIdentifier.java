...
public class AuthorityKeyIdentifier {
	 ...
	 *
	 * @param id
	 *            Issuer public key identifier; may be null.
	 * @param issuerNames
	 *            General names of the certificate issuer; may be null.
	 * @param issuerSerial
	 *            Serial number of issuer certificate; may be null.
	 */
	public AuthorityKeyIdentifier(final KeyIdentifier id,
			final GeneralNameList issuerNames, final Integer issuerSerial) {
		keyIdentifier = id;
	...
	public boolean equals(final Object obj) {
		...
		if (obj == this) {
			...
			result = (keyIdentifier != null ? keyIdentifier.equals(other
					.getKeyIdentifier()) : other.getKeyIdentifier() == null)
					&& (authorityCertIssuer != null ? authorityCertIssuer
							.equals(other.getAuthorityCertIssuer()) : other
							.getAuthorityCertIssuer() == null)
					&& (authorityCertSerialNumber != null ? authorityCertSerialNumber
							.equals(other.getAuthorityCertSerialNumber())
