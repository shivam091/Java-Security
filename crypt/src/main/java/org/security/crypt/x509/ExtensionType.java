...
public enum ExtensionType {
	 ...
	 *            Extension OID value.
	 * @param criticality
	 *            True if extension MUST or SHOULD be marked critical under
	 *            general circumstances, false otherwise.
	 */
	...
	public static ExtensionType fromOid(final String oid) {
		...
		throw new IllegalArgumentException("Invalid X.509v3 extension OID "
				+ oid);
	}
	 ...
	 *
	 * @param name
	 *            Case-sensitive X.509v3 extension name. The acceptable case of
