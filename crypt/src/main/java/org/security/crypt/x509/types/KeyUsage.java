...
public class KeyUsage extends BitString {
	 ...
	 *
	 * @param bitString
	 *            Octets making up key usage bit string.
	 */
	 ...
	 *
	 * @param flags
	 *            Bit mask created by OR-ing the bitmask of {@link KeyUsageBits}
	 ...
	 *
	 * @param bits
	 *            Array of {@link KeyUsageBits} describing all key usage bits to
	 *            be set.
	 */
