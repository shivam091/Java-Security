...
public class BasicConstraints {
	 ...
	 *            Whether or not this is a CA certificate.
	 * @param maxPathLength
	 *            Maximum number of CA certificates that may follow this one.
	 */
	 ...
	 *         certificate, false otherwise. Note that RFC 2459 indicates this
	 *         field MUST BE true for a CA certificate, but that the extension
	 *         SHOULD NOT be present for an end-user certificate.
	 */
	public boolean isCA() {
		return cA;
	}
	 ...
	 *         the certificate chain or null if no path length constraints are
	 *         defined.
	 */
	...
	public boolean equals(final Object obj) {
		...
		if (obj == this) {
			...
			result = cA == other.isCA()
					&& (pathLengthConstraint != null ? pathLengthConstraint
							.equals(other.getPathLengthConstraint()) : other
							.getPathLengthConstraint() == null);
		}
		return result;
	}
