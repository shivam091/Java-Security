...
public class ReasonFlags extends BitString {
	 ...
	 *
	 * @param bitString
	 *            Octets making up reason flags bit string.
	 */
	 ...
	 *
	 * @param flags
	 *            Bit mask created by OR-ing the bitmask of {@link Reasons} enum
	 *            values together, e.g. <code>
	 ...
	 *
	 * @param reasons
	 *            Array of {@link Reasons} describing all key usage bits to be
	 *            set.
	 */
