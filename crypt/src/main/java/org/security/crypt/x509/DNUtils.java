...
import org.security.crypt.x509.types.AttributeType;
import org.security.crypt.x509.types.AttributeTypeAndValue;
...
public final class DNUtils {
	 ...
	 * @param attribute
	 *            Attribute whose values will be retrieved.
	 *
	 * @return The attribute values for the given attribute in the order they
	 *         appear would appear in the string representation of the DN or an
	 *         empty array if the given attribute does not exist.
	 */
	public static String[] getAttributeValues(final X500Principal dn,
	 ...
	 *            X.500 distinguished name.
	 * @param attributeOid
	 *            OID of attribute whose values will be retrieved.
	 *
	 * @return The attribute values for the given attribute in the order they
	 *         appear would appear in the string representation of the DN or an
	 *         empty array if the given attribute does not exist.
	 ...
	 *            X.500 distinguished name.
	 * @param attribute
	 *            Attribute whose value will be retrieved.
	 *
	 * @return Value of first occurrence of given attribute or null if the
	 *         attribute does not exist. The first occurrence is determined by
	 *         the ordering that would result from the string representation of
	 *         the DN.
	 */
	public static String getAttributeValue(final X500Principal dn,
			final AttributeType attribute) {
	 ...
	 *            X.500 distinguished name.
	 * @param attributeOid
	 *            OID of attribute whose value will be retrieved.
	 *
	 * @return Value of first occurrence of given attribute or null if the
	 *         attribute does not exist. The first occurrence is determined by
	 *         the ordering that would result from the string representation of
	 ...
	 *
	 * @param dn
	 *            DN from which to extract common name attribute.
	 *
	 * @return Common name or null if no CN exists. If the DN contains multiple
	 *         CN attributes, only the first one is returned, where the ordering
	 *         of attributes is the same as that of the string representation of
	 *         the DN.
	 */
