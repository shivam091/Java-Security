 ...
 * 
 */
public class RelativeDistinguishedName extends
		AbstractList<AttributeTypeAndValue> {
	...
	public RelativeDistinguishedName(
		...
		items = listOfValues.toArray(new AttributeTypeAndValue[listOfValues
				.size()]);
	}
