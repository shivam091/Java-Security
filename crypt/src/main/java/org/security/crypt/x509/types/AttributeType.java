 ...
 *
 * <p>
 * Enumeration values include attributes likely to appear in an X.509 RDN, which
...
public enum AttributeType {
	 ...
	 *
	 * @param attributeTypeOid
	 *            OID of attribute type.
	 * @param shortName
	 *            Registered short name for the attribute type.
	 */
	 ...
	 *
	 * @param name
	 *            Name of attribute to get, where the name is the all-caps
	 *            RFC/standard name that would be returned by {@link #getName()}
	...
	public static AttributeType fromName(final String name) {
		...
		throw new IllegalArgumentException("Unknown AttributeType for name "
				+ name);
	}
}