...
public class DistributionPoint {
	 ...
	 * @param flags
	 *            Revocation reasons supported by CRL distribution point.
	 * @param issuer
	 *            CRL issuer name(s); cannot be null in this case since this is
	 *            required to give a basis for the relative name.
	 *
	 * @throws IllegalArgumentException
	 *             When issuer is null.
	 */
	public DistributionPoint(final String relativeName,
			final ReasonFlags flags, final GeneralNameList issuer) {
		if (issuer == null) {
	 ...
	 *
	 * @param names
	 *            Name(s) by which CRL distribution point is known.
	 * @param flags
	 *            Revocation reasons supported by CRL distribution point.
	 * @param issuer
	 *            CRL issuer name(s).
	 */
	public DistributionPoint(final GeneralNameList names,
			final ReasonFlags flags, final GeneralNameList issuer) {
	 ...
	 *         otherwise a {@link GeneralNameList} describing the name(s) by
	 *         which the distribution point is known.
	 */
	...
	public boolean equals(final Object obj) {
		...
		if (obj == this) {
			...
			result = (distributionPoint != null ? distributionPoint
					.equals(other.getDistributionPoint()) : other
					.getDistributionPoint() == null)
					&& (reasons != null ? reasons.equals(other.getReasons())
							: other.getReasons() == null)
					&& (cRLIssuer != null ? cRLIssuer.equals(other
							.getCRLIssuer()) : other.getCRLIssuer() == null);
		}
		return result;
	}
