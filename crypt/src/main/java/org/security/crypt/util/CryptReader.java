...
import org.security.crypt.io.PrivateKeyCredentialReader;
import org.security.crypt.io.PublicKeyCredentialReader;
import org.security.crypt.io.SecretKeyCredentialReader;
import org.security.crypt.io.X509CRLCredentialReader;
import org.security.crypt.io.X509CertificateCredentialReader;
import org.security.crypt.io.X509CertificatesCredentialReader;
...
public class CryptReader {
	 ...
	 * @param algorithm
	 *            Symmetric cipher algorithm for which key is used.
	 *
	 * @return Secret key.
	 *
	 ...
	 *             On IO errors.
	 */
	public static SecretKey readSecretKey(final File keyFile,
			final String algorithm) throws CryptException, IOException {
	 ...
	 *             On IO errors.
	 */
	public static SecretKey readSecretKey(final InputStream keyStream,
			final String algorithm) throws CryptException, IOException {
	 ...
	 *
	 * @param keyBytes
	 *            Byte array containing key data.
	 * @param algorithm
	 *            Symmetric cipher algorithm for which key is used.
	 *
	 * @return Secret key.
	 ...
	 *             On IO errors.
	 */
	public static SecretKey readSecretKey(final byte[] keyBytes,
			final String algorithm) throws CryptException, IOException {
	 ...
	 *
	 * @param keyBytes
	 *            Byte array containing private key data.
	 *
	 ...
	 *             On key read errors.
	 */
	public static PrivateKey readPrivateKey(final byte[] keyBytes)
			throws CryptException, IOException {
	 ...
	 */
	public static PrivateKey readPrivateKey(final File keyFile,
			final char[] password) throws CryptException, IOException {
		return new PrivateKeyCredentialReader().read(keyFile, password);
	}

	/**
	 * Reads an encrypted private key in PKCS#8 or OpenSSL "traditional" format
	 * from an input stream into a {@link PrivateKey} object. Both DER and PEM
	...
	/**
	 * Reads an encrypted private key in PKCS#8 or OpenSSL "traditional" format
	 * from a byte array into a {@link PrivateKey} object. Both DER and PEM
	 * encoded keys are supported.
	 *
	 * @param keyBytes
	 *            Byte array containing private key data.
	...
	/**
	 * Reads a DER-encoded X.509 public key from an input stream into a
	 * {@link PublicKey} object.
	 *
	 * @param keyFile
	 *            File containing DER-encoded X.509 public key.
	 *
	...
	/**
	 * Reads a PEM or DER-encoded X.509 public key from an input stream into a
	 * {@link PublicKey} object.
	 *
	 * @param keyStream
	 *            Input stream containing DER-encoded X.509 public key.
	 *
	...
	/**
	 * Reads a PEM or DER-encoded X.509 public key from a byte array into a
	 * {@link PublicKey} object.
	 *
	 * @param keyBytes
	 *            Byte array containing DER-encoded X.509 public key.
	 *
	 ...
	 *             On key read errors.
	 */
	public static PublicKey readPublicKey(final byte[] keyBytes)
			throws CryptException, IOException {
		return readPublicKey(new ByteArrayInputStream(keyBytes));
	}

	/**
	 * Reads a PEM or DER-encoded certificate of the default type from a file
	...
	/**
	 * Reads a PEM or DER-encoded certificate of the given type from a file into
	 * a {@link Certificate} object.
	 *
	 * @param certFile
	 *            Path to certificate file.
	 * @param type
	 *            Type of certificate to read, e.g. X.509.
	 *
	 * @return Certificate containing data read from file.
	 *
	 * @throws CryptException
	 ...
	 */
	public static Certificate readCertificate(final File certFile,
			final String type) throws CryptException, IOException {
	 ...
	 *
	 * @param certStream
	 *            Input stream with certificate data.
	 *
	 * @return Certificate created from data read from stream.
	 *
	 * @throws CryptException
	 *             On certificate read or format errors.
	 * @throws IOException
	 *             On read errors.
	 */
	...
	/**
	 * Reads a PEM or DER-encoded certificate of the default type from a byte
	 * array into a {@link Certificate} object.
	 *
	 * @param certBytes
	 *            Byte array containing certificate data.
	 *
	 ...
	 *             On read errors.
	 */
	public static Certificate readCertificate(final byte[] certBytes)
			throws CryptException, IOException {
	 ...
	 * containing data in any of the formats supported by
	...
	/**
	 * Reads a certificate chain of the given type from a file containing data
	 * in any of the formats supported by
	 * {@link #readCertificateChain(InputStream, String)}.
	 *
	 * @param chainFile
	 *            Path to certificate chain file.
	 ...
	 * stream containing data in any of the formats supported by
	 * {@link #readCertificateChain(InputStream, String)}.
	 *
	 * @param chainStream
	 *            Stream containing certificate chain data.
	 *
	 * @return Array of certificates in the order in which they appear in the
	 *         stream.
	 *
	...
	public static Certificate[] readCertificateChain(
			final InputStream chainStream) throws CryptException, IOException {
	 ...
	 */
	public static Certificate[] readCertificateChain(
			final InputStream chainStream, final String type)
			throws CryptException, IOException {
		if (!DEFAULT_CERTIFICATE_TYPE.equals(type)) {
			throw new UnsupportedOperationException(type + " not supported.");
		}
	...
	/**
	 * Reads a certificate chain of the default certificate type from a byte
	 * array containing data in any of the formats supported by
	 * {@link #readCertificateChain(InputStream, String)}.
	 *
	 * @param chainBytes
	 *            Byte array containing certificate chain data.
	 *
	 * @return Array of certificates in the order in which they appear in the
	 *         given byte array.
	 *
	...
	/**
	 * Reads a certificate chain of the given type from a byte array containing
	 * data in any of the formats supported by
	 * {@link #readCertificateChain(InputStream, String)}.
	 *
	 * @param chainBytes
	 *            Byte array containing certificate chain data.
	...
	/**
	 * Reads a PEM or DER-encoded X.509 CRL from an input stream into an
	 * {@link X509CRL} object.
	 *
	 * @param crlStream
	 *            Input stream with CRL data.
	 *
	 ...
	 *             On read errors.
	 * @throws CryptException
	 *             On CRL read or format errors.
	 */
	public static X509CRL readCRL(final InputStream crlStream)
			throws CryptException, IOException {
		return new X509CRLCredentialReader().read(crlStream);
	}

	/**
	 * Reads a PEM or DER-encoded X.509 CRL from a file into an {@link X509CRL}
	 * object.
	 *
	 * @param crlFile
	 *            Path to CRL file.
	 ...
	 *             On CRL read or format errors.
	 */
	public static X509CRL readCRL(final File crlFile) throws CryptException,
			IOException {
		return new X509CRLCredentialReader().read(toInputStream(crlFile));
	}

	/**
	 * Reads a PEM or DER-encoded X.509 CRL from a byte array into an
	 * {@link X509CRL} object.
	 *
	 * @param crlBytes
	 *            Byte array containing CRL data.
	 *
	 ...
	 *             On CRL read or format errors.
	 */
	public static X509CRL readCRL(final byte[] crlBytes) throws CryptException,
			IOException {
		return new X509CRLCredentialReader().read(new ByteArrayInputStream(
				crlBytes));
	}
	 ...
	 *
	 * @param file
	 *            File from which to obtain input stream.
	 *
