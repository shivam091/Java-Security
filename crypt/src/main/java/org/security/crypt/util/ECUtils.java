...
public final class ECUtils {
	 ...
	 *
	 * @param seq
	 *            ASN.1 encoded sequence of EC private key parameters.
	 *
	...
	public static ECPrivateKeySpec readEncodedPrivateKey(final ASN1Sequence seq) {
		final BigInteger s = DERInteger.getInstance(seq.getObjectAt(1))
				.getValue();
		final ASN1TaggedObject params = DERTaggedObject.getInstance(seq
				.getObjectAt(2));
		return new ECPrivateKeySpec(s,
	 ...
	 *
	 * @param seq
	 *            ASN.1 sequence of EC domain parameters.
	 *
	 ...
	 *
	 * @param curveOid
	 *            Named elliptic curve object identifier.
	 *
	 ...
	 *
	 * @param params
	 *            BC elliptic curve domain parameters.
	 *
	...
	private static ECParameterSpec convertParams(final X9ECParameters params) {
		final EllipticCurve curve = EC5Util.convertCurve(params.getCurve(),
				params.getSeed());
