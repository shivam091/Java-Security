...
public final class PublicKeyUtils {
	...
	/**
	 * Gets the length in bits of a public key where key size is dependent on
	 * the particulars of the algorithm.
	 *
	 * <ul>
	...
	/**
	 * Gets the length in bits of a private key where key size is dependent on
	 * the particulars of the algorithm.
	 *
	 * <ul>
	...
	/**
	 * Generates a key pair of the given length with default algorithm
	 * parameters.
	 *
	 * @param algorithm
	 *            Name of a cipher algorithm for which a suitable key pair will
	 *            be generated.
	 * @param bitLength
	 *            Size of each key in pair in bits.
	 *
	 * @return Key pair that may be used for encryption/decryption on a cipher
	 *         of the given algorithm.
	 *
	 * @throws CryptException
	 *             On key pair generation errors.
	 */
	 ...
	 *            Size of each key in pair in bits.
	 * @param random
	 *            Source of randomness used for key generation.
	 *
	 * @return Key pair that may be used for encryption/decryption on a cipher
	 *         of the given algorithm.
	 *
	 ...
	 */
	public static KeyPair generate(final String algorithm, final int bitLength,
			final SecureRandom random) throws CryptException {
		if (random == null) {
			throw new CryptException("Source of random data cannot be null.");
		}

		final KeyPairGenerator generator = CryptProvider
				.getKeyPairGenerator(algorithm);
		try {
	 ...
	 *             On key pair generation errors.
	 */
	public static KeyPair generate(final String algorithm,
			final AlgorithmParameterSpec params) throws CryptException {
	...
	public static KeyPair generate(final String algorithm,
		...
		try {
			...
			throw new CryptException(String.format(
					"Error generatig %s key with %s", algorithm, params), ex);
		}
	}

	/**
	 * Determines whether the given public and private keys form a proper key
	 ...
	 *         otherwise. Errors during signature verification are treated as
	 *         false.
	 */
	public static boolean isKeyPair(final PublicKey pubKey,
