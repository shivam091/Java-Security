...
public class DigestAlgorithmTest {
	...
	private static final String BIG_FILE_PATH = "/plaintext.txt";

	/**
	 * Map of hash alg names to hash values calculated with GNU utility like
	 * md5sum, sha1sum, etc on CLEARTEXT string.
	 */
	private static final Map<String, String> REFERENCE_HASHES = new HashMap<String, String>();
	...
	static {
		...
		REFERENCE_HASHES.put("SHA-1",
				"b3b976e951f32db9e688218c8d6408e62b361859");
	}
	...
	public Object[][] createTestData() {
		...
		return new Object[][] { { md2, null }, { md2, md2.getRandomSalt() },
				{ md4, null }, { md4, md4.getRandomSalt() }, { md5, null },
				{ md5, md5.getRandomSalt() }, { ripeMD128, null },
				{ ripeMD128, ripeMD128.getRandomSalt() }, { ripeMD160, null },
				{ ripeMD160, ripeMD160.getRandomSalt() }, { ripeMD256, null },
				{ ripeMD256, ripeMD256.getRandomSalt() }, { ripeMD320, null },
				{ ripeMD320, ripeMD320.getRandomSalt() }, { sha1, null },
				{ sha1, sha1.getRandomSalt() }, { sha256, null },
				{ sha256, sha256.getRandomSalt() }, { sha384, null },
				{ sha384, sha384.getRandomSalt() }, { sha512, null },
				{ sha512, sha512.getRandomSalt() }, { tiger, null },
				{ tiger, tiger.getRandomSalt() }, { whirlpool, null },
	...
	public Object[][] createTestDataForConvert() {
		...
		return new Object[][] { { md5, new HexConverter() },
				{ md5, new Base64Converter() }, { sha1, new HexConverter() },
	...
	public Object[][] createTestDataForRefTest() {
		return new Object[][] { { new MD5() }, { new SHA1() }, };
	}
	...
	public Object[][] createTestDataForClone() throws Exception {
		final DigestAlgorithm sha256 = new SHA256();
		sha256.setRandomByteSize(16);
		sha256.setSalt(sha256.getRandomSalt());
		return new Object[][] { { new MD5() }, { new SHA1() }, { sha256 }, };
	}

	/**
	 * @param digest
	 *            A digest instance to test.
	 * @param salt
	 *            Initial salt data.
	 *
	 * @throws Exception
	...
	public void testDigest(final DigestAlgorithm digest, final byte[] salt)
		...
		AssertJUnit.assertEquals(digest.digest(CLEARTEXT.getBytes()),
	 ...
	 *            A digest instance to test.
	 * @param converter
	 *            Converter used to convert digest output bytes to string.
	 *
	 * @throws Exception
	 *             On test failure.
	 */
	@Test(groups = { "functest", "digest" }, dataProvider = "testdataconv")
	public void testDigestConvert(final DigestAlgorithm digest,
	 ...
	 */
	@Test(groups = { "functest", "digest" }, dataProvider = "testdataconv")
	public void testDigestStream(final DigestAlgorithm digest,
			final Converter converter) throws Exception {
		logger.info("Testing digest stream handling for {} using converter {}",
				digest, converter);
	...
	public void testHashCalculationAgainstReference(final DigestAlgorithm digest)
		...
		final String testHash = digest.digest(CLEARTEXT.getBytes("ASCII"),
				new HexConverter());
		AssertJUnit.assertEquals(REFERENCE_HASHES.get(digest.getAlgorithm()),
				testHash);
	}

	/**
	 * @param algorithm
	 *            Digest algorithm to clone and test.
	 *
	 * @throws Exception
	 *             On test failure.
	 */
	@Test(groups = { "functest", "digest" }, dataProvider = "testclone")
	public void testClone(final DigestAlgorithm algorithm) throws Exception {
		final DigestAlgorithm clone = (DigestAlgorithm) algorithm.clone();
		final byte[] cleartext = "Able was I ere I saw elba".getBytes();
		AssertJUnit.assertArrayEquals(algorithm.digest(cleartext),
				clone.digest(cleartext));
	}
}