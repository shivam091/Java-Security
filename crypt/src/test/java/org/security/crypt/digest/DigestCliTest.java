...
public class DigestCliTest {
	...
	public Object[][] createTestData() throws Exception {
		return new Object[][] {
				{ "-alg MD4", null, },
				{ "-alg MD5 -encoding base64 -salt D3ADF00D", null, },
				{ "-alg MD5 -encoding base64", "jkdiaM9v/g6hNQSr5hnmgQ==", },
				{ "-alg RIPEMD128 -encoding hex", null, },
				{ "-alg RIPEMD160 -encoding hex", null, },
				{ "-alg RIPEMD256 -encoding hex", null, },
				{ "-alg RIPEMD320 -encoding hex", null, },
	 ...
	 * @param expected
	 *            Expected result of digest operation.
	 *
	 * @throws Exception
	 *             On test failure.
	 */
