...
public class DNUtilsTest {
	...
	public Object[][] createMultipleValuesTestData() throws Exception {
		return new Object[][] {
	...
	public Object[][] createSingleValuesTestData() throws Exception {
		return new Object[][] {
				{ new File(RESOURCE_DIR, "serac-dev-test-cert.pem"),
						AttributeType.DomainComponent, "vt", },
				{ new File(RESOURCE_DIR, "glider.cc.vt.edu.crt"),
						AttributeType.CommonName, "glider.cc.vt.edu", },
	...
	public void testGetAttributeValues(final File certFile,
			final AttributeType attribute, final String[] expectedValues)
			throws Exception {
		logger.info("Testing getting attribute values of subject DN of {}",
				certFile);
		...
		final String[] actualValues = DNUtils.getAttributeValues(
				cert.getSubjectX500Principal(), attribute);
		AssertJUnit.assertEquals(Arrays.asList(expectedValues),
	...
	public void testGetAttributeValue(final File certFile,
			final AttributeType attribute, final String expectedValue)
			throws Exception {
		logger.info("Testing getting attribute value of subject DN of {}",
				certFile);
