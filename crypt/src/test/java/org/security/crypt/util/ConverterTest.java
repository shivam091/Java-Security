...
public class ConverterTest {
	...
	/** Data for testing. */
	private static final String CLEARTEXT = "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. "
	...
	public Object[][] createTestData() throws Exception {
		return new Object[][] { { new Base64Converter() },
				{ new HexConverter() }, { new HexConverter(true) }, };
	}
